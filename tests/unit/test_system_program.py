...
def test_create_nonce_account():
    ...
    create_account_txn.add_signature(from_keypair.pubkey(), from_keypair.sign_message(create_account_hash))
    create_account_txn.add_signature(nonce_keypair.pubkey(), nonce_keypair.sign_message(create_account_hash))
...
def test_advance_nonce_and_transfer():
    ...
    txn.add_signature(from_keypair.pubkey(), from_keypair.sign_message(txn_hash))

...
@mark.integration
@mark.asyncio
async def test_get_recent_performance_samples_async(test_http_client_async, wait_until_ready):
...
@mark.integration
def test_get_recent_performance_samples(test_http_client, wait_until_ready):

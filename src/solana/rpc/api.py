...
class Client(_ClientCore):  # pylint: disable=too-many-public-methods
    ...
    def __init__(
        ...
        self._provider = http.HTTPProvider(
    ...
    def get_recent_prioritization_fees(
        ...
        Example:
            >>> solana_client = Client("http://localhost:8899")
            >>> solana_client.get_recent_prioritization_fees().value[0] # doctest: +SKIP
        ...
        return self._provider.make_request(body, GetRecentPrioritizationFeesResp)
    ...
    def get_program_accounts(  # pylint: disable=too-many-arguments
        ...
        data_slice: Optional[Union[types.DataSliceOpts, DataSliceOptsModel]] = None,
        filters: Optional[
            Sequence[Union[int, types.MemcmpOpts, MemcmpOptsModel]]
        ] = None,
    ) -> GetProgramAccountsResp:

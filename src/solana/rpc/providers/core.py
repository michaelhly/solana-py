...
from solders.rpc.responses import Resp, RpcError, batch_from_json as batch_resp_json, RPCResult as RPCResultType, GetAccountInfoResp, GetBlockResp
...
_T1 = TypeVar("_T1", bound=RPCResultType)
_T2 = TypeVar("_T2", bound=RPCResultType)
_T3 = TypeVar("_T3", bound=RPCResultType)
_T4 = TypeVar("_T4", bound=RPCResultType)
_T5 = TypeVar("_T5", bound=RPCResultType)
...
def _parse_raw_batch(raw: str, parsers: _Tuples) -> Tuple[RPCResultType, ...]:
...
def _after_batch_request(raw_response: Union[requests.Response, httpx.Response], parsers: _Tuples) -> Tuple[RPCResultType, ...]:
    text = _after_request_unparsed(raw_response)
